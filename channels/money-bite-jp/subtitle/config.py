...
SUBTITLE_FONT_PATH = os.path.join(FONT_DIR, "notosansjp", "NotoSansJP-Bold.ttf")
...
# 2. 키워드-카테고리 매핑 (일본어 금융 키워드)
KEYWORD_CATEGORIES = {
    'WARNING': [
        "絶対", "ダメ", "ミス", "間違い", "危険", "暴落", "損害", "損失",
        "借金", "負債", "詐欺", "罠", "高い", "割高", "恐怖", "パニック",
        "破綻", "破産", "滞納", "浪費",
    ],
    'EMPHASIS': [
        "必ず", "無条件", "核心", "秘密", "最高", "最大", "重要",
        "記憶", "銘記", "必須", "利益", "利子", "配当", "利回り",
    ],
    'SECRET': [
        "コツ", "秘訣", "戦略", "法則", "方法", "公式", "ルール",
        "複利", "配当金", "インデックス", "ポートフォリオ", "分散", "ETF",
        "投資", "資産運用", "積立", "資産", "ファンド", "指数",
        "株式", "債券", "不動産",
    ],
    'URGENT': [
        "今", "今日", "すぐ", "直ちに", "早く", "急いで",
...
SUBTITLE_IMPACT_KEYWORDS = ["絶対", "必ず", "秘密", "記憶", "法則", "核心"]
