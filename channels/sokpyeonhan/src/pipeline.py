...
"""
            ...
            summary_data = self.script_gen.generate_summary(full_content, kick=kick)
            ...
            if summary_checklist:
                debug_logger.log_prompt_step(7, "핵심 정보 카드 생성", full_content, "(SUMMARY_GENERATION_PROMPT 사용)", str(summary_data), "SUMMARY_GENERATION_PROMPT")
